    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sumary', models.TextField(blank=True, max_length=4000, null=True, verbose_name='sumary')),
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Unique ID for book copy', primary_key=True, serialize=False, verbose_name='ID')),
                ('due_back', models.DateField(db_index=True, null=True, verbose_name='due_back')),
